...
variable "dashboard_frontend_ingress" {
  type        = bool
  description = "Dashboard frontend ingress"
  default     = false
}

variable "dashboard_api_ingress" {
  type        = bool
  description = "Dashboard api ingress"
  default     = false
}

variable "ingress_cert" {
  type        = string
  description = "Certificate for ingress alb"
  default     = "arn:aws:acm:us-east-1:038249548279:certificate/a919191b-6bb5-4ea4-9269-a8992d526271"
}
...
variable "mimir_irsa" {
  type        = any
  description = "mimir irsa config"
  default     = {}
}

variable "kyverno_irsa" {
  type        = any
  description = "mimir irsa config"
  default     = {}
}
...
variable "mimir_s3_buckets" {
  type        = any
  default     = []
  description = "Mimir S3 buckets names"
}

variable "enable_kyverno_notation_aws" {
  type        = bool
  default     = false
  description = "Enable kyverno notation aws addon"
}

variable "eks_worker_fips_image_id" {
  description = "AMI ID for EKS worker node"
  type = string
  default = "ami-0f203b92b9de3e5dc"
}
